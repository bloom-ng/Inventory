...
class DepartmentControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_departments()
    {
     ...
     * @test
     */
    public function it_displays_create_view_for_department()
    {
     ...
     * @test
     */
    public function it_displays_show_view_for_department()
    {
     ...
     * @test
     */
    public function it_displays_edit_view_for_department()
    {
        $department = Department::factory()->create();
